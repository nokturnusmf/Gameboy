...
long Emulator::execute_bits() {
    ...
    case 0x46: // bit 0, (hl)
        cpu.flags = (~memmap(cpu.hl) & 0x01) | HALFCARRY_FLAG | (cpu.flags & CARRY_FLAG);
        ++cpu.pc;
        return 12;
    ...
    case 0x4E: // bit 1, (hl)
        cpu.flags = (~memmap(cpu.hl) & 0x02) | HALFCARRY_FLAG | (cpu.flags & CARRY_FLAG);
        ++cpu.pc;
        return 12;
    ...
    case 0x56: // bit 2, (hl)
        cpu.flags = (~memmap(cpu.hl) & 0x04) | HALFCARRY_FLAG | (cpu.flags & CARRY_FLAG);
        ++cpu.pc;
        return 12;
    ...
    case 0x5E: // bit 3, (hl)
        cpu.flags = (~memmap(cpu.hl) & 0x08) | HALFCARRY_FLAG | (cpu.flags & CARRY_FLAG);
        ++cpu.pc;
        return 12;
    ...
    case 0x66: // bit 4, (hl)
        cpu.flags = (~memmap(cpu.hl) & 0x10) | HALFCARRY_FLAG | (cpu.flags & CARRY_FLAG);
        ++cpu.pc;
        return 12;
    ...
    case 0x6E: // bit 5, (hl)
        cpu.flags = (~memmap(cpu.hl) & 0x20) | HALFCARRY_FLAG | (cpu.flags & CARRY_FLAG);
        ++cpu.pc;
        return 12;
    ...
    case 0x76: // bit 6, (hl)
        cpu.flags = (~memmap(cpu.hl) & 0x40) | HALFCARRY_FLAG | (cpu.flags & CARRY_FLAG);
        ++cpu.pc;
        return 12;
    ...
    case 0x7E: // bit 7, (hl)
        cpu.flags = (~memmap(cpu.hl) & 0x80) | HALFCARRY_FLAG | (cpu.flags & CARRY_FLAG);
        ++cpu.pc;
        return 12;
